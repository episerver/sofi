...
namespace Foundation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Content Management
            services.AddContentManagementApi(OpenIDConnectOptionsDefaults.AuthenticationScheme, c =>
            {
                // Accept anonymous calls
            ...
            services.AddOpenIDConnect<SiteUser>(options =>
            {
                ...
                application.RedirectUris.Add(new Uri("https://localhost:7068/signin-github"));
